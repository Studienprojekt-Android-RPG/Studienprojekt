...
public class mapManager {
	...
	public void update(){
		...
		switch(map){  
		case "maps/demondus1.tmx":	Demtheme.play();
		...
		case "maps/demondus2.tmx":	Demtheme.play();
									if(Intersector.overlaps(exit1, player.getBounds())){
		...
		case "maps/demondus3.tmx": 	Demtheme.play();
									if(Intersector.overlaps(exit1, player.getBounds())){
										mapchange = "maps/demondus2.tmx";
										changeMap(mapchange, map, spawn3);
									}							
		...
		case "maps/demondus4.tmx":	Demtheme.play();
									if(Intersector.overlaps(exit1, player.getBounds())){
										mapchange = "maps/demondus3.tmx";
										changeMap(mapchange, map, spawn2);
									}
		...
		case "maps/demondus5.tmx": Demtheme.play();
									if(Intersector.overlaps(exit1, player.getBounds())){
										mapchange = "maps/demondus4.tmx";
										changeMap(mapchange, map, spawn3);
									}
		...
		case "maps/wehhh.tmx":		Demtheme.play();
									if(Intersector.overlaps(exit1, player.getBounds())){
										mapchange = "maps/room.tmx";
										changeMap(mapchange, map, spawn7);
									}
		...
		case "maps/room.tmx":		Demtheme.play();
									if(Intersector.overlaps(exit1, player.getBounds())){
										mapchange = "maps/demondus2.tmx";
										changeMap(mapchange, map, spawn2);
									}
		...
		case "maps/demondus7.tmx":	if(Intersector.overlaps(exit1, player.getBounds())){
										mapchange = "maps/demondus3.tmx";
										changeMap(mapchange, map, spawn3);
									}
									if(Intersector.overlaps(exit2, player.getBounds())){
		...
		case "maps/demondusdorf.tmx":	if(Intersector.overlaps(exit1, player.getBounds())){
											mapchange = "maps/demondus7.tmx";
											changeMap(mapchange, map, spawn2);
										}
										if(Intersector.overlaps(exit2, player.getBounds())){
		...
		case "maps/kathedrale.tmx":		Demtheme.play();
									if(Intersector.overlaps(exit1, player.getBounds())){
										mapchange = "maps/demondusdorf.tmx";
										changeMap(mapchange, map, spawn5);
									}
		...
		case "maps/Dach_Tag.tmx":	if(Intersector.overlaps(exit1, player.getBounds())){
										mapchange = "maps/Sozialzweig.tmx";
										changeMap(mapchange, map, spawn3);
									}
		break;
		
		case "maps/Dach_Nacht.tmx":	if(Intersector.overlaps(exit1, player.getBounds())){
										mapchange = "maps/Sozialzweig.tmx";
										changeMap(mapchange, map, spawn3);
									}
		break;
		
		case "maps/Hauptweg_Tag.tmx":	if(Intersector.overlaps(exit1, player.getBounds())){
		...
		case "maps/Hauptweg_Nacht.tmx":	if(Intersector.overlaps(exit1, player.getBounds())){
											mapchange = "maps/leonswohnung.tmx";
											changeMap(mapchange, map, spawn1);
										}
										if(Intersector.overlaps(exit2, player.getBounds())){
		...
		case "maps/Lichtung_Tag.tmx":	if(Intersector.overlaps(exit1, player.getBounds())){
		...
		case "maps/Lichtung_Nacht.tmx":	if(Intersector.overlaps(exit1, player.getBounds())){
		...
		case "maps/See_Tag.tmx": if(Intersector.overlaps(exit1, player.getBounds())){
									mapchange = "maps/WegZumSee_Tag.tmx";
									changeMap(mapchange, map, spawn2);
								}
		break;
		
		case "maps/See_Nacht.tmx": if(Intersector.overlaps(exit1, player.getBounds())){
									mapchange = "maps/WegZumSee_Nacht.tmx";
									changeMap(mapchange, map, spawn2);
								}
		break;
		
		case "maps/WegZumSee_Tag.tmx":	if(Intersector.overlaps(exit1, player.getBounds())){
											mapchange = "maps/Hauptweg_Tag.tmx";
											changeMap(mapchange, map, spawn1);
										}
										if(Intersector.overlaps(exit2, player.getBounds())){
		...
		case "maps/WegZumSee_Nacht.tmx":	if(Intersector.overlaps(exit1, player.getBounds())){
											mapchange = "maps/Hauptweg_Nacht.tmx";
											changeMap(mapchange, map, spawn1);
										}
										if(Intersector.overlaps(exit2, player.getBounds())){
		...
		break;
		case "maps/Sozialzweig.tmx":	if(Intersector.overlaps(exit1, player.getBounds())){
											mapchange = "maps/IF2.tmx";
											changeMap(mapchange, map, spawn2);
										}
										if(Intersector.overlaps(exit2, player.getBounds())){
		...
		case "maps/cafeteria.tmx":	if(Intersector.overlaps(exit1, player.getBounds())){
		...
		case "maps/altbau.tmx":	if(Intersector.overlaps(exit1, player.getBounds())){
									mapchange = "maps/IF2.tmx";
		...
		case "maps/IF2.tmx":	if(Intersector.overlaps(exit1, player.getBounds())){
									mapchange = "maps/Hauptweg_Tag.tmx";
									changeMap(mapchange, map, spawn2);
								}
								if(Intersector.overlaps(exit2, player.getBounds())){
		...
		case "maps/ho.tmx":		if(Intersector.overlaps(exit1, player.getBounds())){
		...
		case "maps/maze.tmx":	if(Intersector.overlaps(exit1, player.getBounds())){
		...
		case "maps/leonswohnung.tmx":	if(Intersector.overlaps(exit1, player.getBounds())){
											mapchange = "maps/Hauptweg_Tag.tmx";
											changeMap(mapchange, map, spawn3);
										}
										if(Intersector.overlaps(exit2, player.getBounds())){
...
//					battlescreen = new Battlescreen(Testmap.gameT);
					loadscreen = new LoadScreen(Testmap.gameT);
					safety = 0;
//					Gamescreen.game.setScreen(battlescreen);
					Gamescreen.game.setScreen(loadscreen);
				}
			}	
		}
	}
	...
	public void setBattle(){
	    ...
	    mapHeight = prop.get("height", Integer.class);
	      for (int i = 0; i < mapWidth; i++){
	    	  for (int j = 0; j < mapHeight; j++){
	    		  TiledMapTileLayer bat = (TiledMapTileLayer) Gamescreen.tiledMap.getLayers().get("Battle");
	    		  Cell cellB = new Cell();
	...
	public void getSpawnpoints(){
		...
		switch(map){
			case "maps/demondus1.tmx":	RectangleMapObject rect1 = (RectangleMapObject) layer.getObjects().get("spawnpoint1");
			...
			case "maps/demondus2.tmx":	RectangleMapObject rect5 = (RectangleMapObject) layer.getObjects().get("spawnpoint1");
			...
			case "maps/room.tmx":		RectangleMapObject rect8 = (RectangleMapObject) layer.getObjects().get("sprode2");
			...
			case "maps/demondus3.tmx":	RectangleMapObject rect19 = (RectangleMapObject) layer.getObjects().get("spde2");
			...
			case "maps/demondus4.tmx":	RectangleMapObject rect23 = (RectangleMapObject) layer.getObjects().get("spde3");
			...
			case "maps/demondus5.tmx":	RectangleMapObject rect26 = (RectangleMapObject) layer.getObjects().get("spcade4");
			...
			case "maps/wehhh.tmx":		RectangleMapObject rect27 = (RectangleMapObject) layer.getObjects().get("spsede3");
			...
			case "maps/demondus7.tmx":	RectangleMapObject rect28 = (RectangleMapObject) layer.getObjects().get("spde3");
			...
			case "maps/demondusdorf.tmx":	RectangleMapObject rect30 = (RectangleMapObject) layer.getObjects().get("spde7");
			...
			case "maps/kathedrale.tmx":	RectangleMapObject rect35 = (RectangleMapObject) layer.getObjects().get("spdd");
			...
			case "maps/Dach_Tag.tmx": 	RectangleMapObject rect48 = (RectangleMapObject) layer.getObjects().get("spdach");
			...
			case "maps/Dach_Nacht.tmx":	RectangleMapObject rect49 = (RectangleMapObject) layer.getObjects().get("spdach");
			...
			case "maps/Hauptweg_Tag.tmx":	RectangleMapObject rect50 = (RectangleMapObject) layer.getObjects().get("spwese");
											playerx = (int) rect50.getRectangle().x;
											playery = (int) rect50.getRectangle().y;
											spawn1.x = playerx;
											spawn1.y = playery;
			
											RectangleMapObject rect51 = (RectangleMapObject) layer.getObjects().get("sphof");
											playerx = (int) rect51.getRectangle().x;
											playery = (int) rect51.getRectangle().y;
											spawn2.x = playerx;
											spawn2.y = playery;
											
											RectangleMapObject rect52 = (RectangleMapObject) layer.getObjects().get("spwo");
											playerx = (int) rect52.getRectangle().x;
											playery = (int) rect52.getRectangle().y;
											spawn3.x = playerx;
											spawn3.y = playery;
											
											RectangleMapObject rect53 = (RectangleMapObject) layer.getObjects().get("splich");
			...
			case "maps/Hauptweg_Nacht.tmx":	RectangleMapObject rect54 = (RectangleMapObject) layer.getObjects().get("spwese");
											playerx = (int) rect54.getRectangle().x;
											playery = (int) rect54.getRectangle().y;
											spawn1.x = playerx;
											spawn1.y = playery;
								
											RectangleMapObject rect55 = (RectangleMapObject) layer.getObjects().get("sphof");
											playerx = (int) rect55.getRectangle().x;
											playery = (int) rect55.getRectangle().y;
											spawn2.x = playerx;
											spawn2.y = playery;
											
											RectangleMapObject rect56 = (RectangleMapObject) layer.getObjects().get("spwo");
											playerx = (int) rect56.getRectangle().x;
											playery = (int) rect56.getRectangle().y;
											spawn3.x = playerx;
											spawn3.y = playery;
											
											RectangleMapObject rect57 = (RectangleMapObject) layer.getObjects().get("splich");
			...
			case "maps/Lichtung_Tag.tmx":	RectangleMapObject rect58 = (RectangleMapObject) layer.getObjects().get("sphawe");
											playerx = (int) rect58.getRectangle().x;
											playery = (int) rect58.getRectangle().y;
											spawn1.x = playerx;
											spawn1.y = playery;
								
											RectangleMapObject rect59 = (RectangleMapObject) layer.getObjects().get("spwo");
			...
			case "maps/Lichtung_Nacht.tmx":	RectangleMapObject rect60 = (RectangleMapObject) layer.getObjects().get("sphawe");
											playerx = (int) rect60.getRectangle().x;
											playery = (int) rect60.getRectangle().y;
											spawn1.x = playerx;
											spawn1.y = playery;
								
											RectangleMapObject rect61 = (RectangleMapObject) layer.getObjects().get("spwo");
			...
			case "maps/WegZumSee_Tag.tmx":	RectangleMapObject rect62 = (RectangleMapObject) layer.getObjects().get("sphawe");
											playerx = (int) rect62.getRectangle().x;
											playery = (int) rect62.getRectangle().y;
											spawn1.x = playerx;
											spawn1.y = playery;
											
											RectangleMapObject rect156 = (RectangleMapObject) layer.getObjects().get("spsee");
			...
			case "maps/WegZumSee_Nacht.tmx":	RectangleMapObject rect63 = (RectangleMapObject) layer.getObjects().get("sphawe");
												playerx = (int) rect63.getRectangle().x;
												playery = (int) rect63.getRectangle().y;
												spawn1.x = playerx;
												spawn1.y = playery;
												
												RectangleMapObject rect157 = (RectangleMapObject) layer.getObjects().get("spsee");
			...
			case "maps/See_Tag.tmx":	RectangleMapObject rect64 = (RectangleMapObject) layer.getObjects().get("spwese");
			...
			case "maps/See_Nacht.tmx":	RectangleMapObject rect65 = (RectangleMapObject) layer.getObjects().get("spwese");
			...
			case "maps/Sozialzweig.tmx":	RectangleMapObject rect66 = (RectangleMapObject) layer.getObjects().get("spho1");
											playerx = (int) rect66.getRectangle().x;
											playery = (int) rect66.getRectangle().y;
											spawn1.x = playerx;
											spawn1.y = playery;
											
											RectangleMapObject rect68 = (RectangleMapObject) layer.getObjects().get("spdach");
											playerx = (int) rect68.getRectangle().x;
											playery = (int) rect68.getRectangle().y;
											spawn3.x = playerx;
											spawn3.y = playery;			
											
											RectangleMapObject rect69 = (RectangleMapObject) layer.getObjects().get("speg");
											playerx = (int) rect69.getRectangle().x;
											playery = (int) rect69.getRectangle().y;
											spawn4.x = playerx;
											spawn4.y = playery;
											
											RectangleMapObject rect70 = (RectangleMapObject) layer.getObjects().get("sp1s");
											playerx = (int) rect70.getRectangle().x;
											playery = (int) rect70.getRectangle().y;
											spawn5.x = playerx;
											spawn5.y = playery;																						
											
											RectangleMapObject rect71 = (RectangleMapObject) layer.getObjects().get("sp12s");
											playerx = (int) rect71.getRectangle().x;
											playery = (int) rect71.getRectangle().y;
											spawn6.x = playerx;
											spawn6.y = playery;
											
											RectangleMapObject rect72 = (RectangleMapObject) layer.getObjects().get("sp2s");
											playerx = (int) rect72.getRectangle().x;
											playery = (int) rect72.getRectangle().y;
											spawn7.x = playerx;
											spawn7.y = playery;
											
											RectangleMapObject rect73 = (RectangleMapObject) layer.getObjects().get("spbiog");
											playerx = (int) rect73.getRectangle().x;
											playery = (int) rect73.getRectangle().y;
											spawn8.x = playerx;
											spawn8.y = playery;
											
											RectangleMapObject rect74 = (RectangleMapObject) layer.getObjects().get("spbiug");
											playerx = (int) rect74.getRectangle().x;
											playery = (int) rect74.getRectangle().y;
											spawn9.x = playerx;
											spawn9.y = playery;
											
											RectangleMapObject rect75 = (RectangleMapObject) layer.getObjects().get("spbib1");
											playerx = (int) rect75.getRectangle().x;
											playery = (int) rect75.getRectangle().y;
											spawn10.x = playerx;
											spawn10.y = playery;			
											
											RectangleMapObject rect76 = (RectangleMapObject) layer.getObjects().get("spbib2");
											playerx = (int) rect76.getRectangle().x;
											playery = (int) rect76.getRectangle().y;
											spawn11.x = playerx;
											spawn11.y = playery;											
																					
											RectangleMapObject rect77 = (RectangleMapObject) layer.getObjects().get("spbi1");
											playerx = (int) rect77.getRectangle().x;
											playery = (int) rect77.getRectangle().y;
											spawn12.x = playerx;
											spawn12.y = playery;
											
											RectangleMapObject rect78 = (RectangleMapObject) layer.getObjects().get("spbi2");
											playerx = (int) rect78.getRectangle().x;
											playery = (int) rect78.getRectangle().y;
											spawn13.x = playerx;
											spawn13.y = playery;				
			break;
			case "maps/cafeteria.tmx": 		RectangleMapObject rect79 = (RectangleMapObject) layer.getObjects().get("spcaif");
											playerx = (int) rect79.getRectangle().x;
											playery = (int) rect79.getRectangle().y;
											spawn1.x = playerx;
											spawn1.y = playery;
											
											RectangleMapObject rect80 = (RectangleMapObject) layer.getObjects().get("spcake");
											playerx = (int) rect80.getRectangle().x;
											playery = (int) rect80.getRectangle().y;
											spawn2.x = playerx;
											spawn2.y = playery;
											
											RectangleMapObject rect81 = (RectangleMapObject) layer.getObjects().get("spkeca");
											playerx = (int) rect81.getRectangle().x;
											playery = (int) rect81.getRectangle().y;
											spawn3.x = playerx;
											spawn3.y = playery;			
											
											RectangleMapObject rect82 = (RectangleMapObject) layer.getObjects().get("sproca");
											playerx = (int) rect82.getRectangle().x;
											playery = (int) rect82.getRectangle().y;
											spawn4.x = playerx;
											spawn4.y = playery;			
											
											RectangleMapObject rect83 = (RectangleMapObject) layer.getObjects().get("spcaro");
											playerx = (int) rect83.getRectangle().x;
											playery = (int) rect83.getRectangle().y;
											spawn5.x = playerx;
											spawn5.y = playery;
				
											RectangleMapObject rect84 = (RectangleMapObject) layer.getObjects().get("spca");
											playerx = (int) rect84.getRectangle().x;
											playery = (int) rect84.getRectangle().y;
											spawn6.x = playerx;
											spawn6.y = playery;
											
											RectangleMapObject rect85 = (RectangleMapObject) layer.getObjects().get("spke");
			...
			case "maps/altbau.tmx":	RectangleMapObject rect86 = (RectangleMapObject) layer.getObjects().get("spif2");
										playerx = (int) rect86.getRectangle().x;
										playery = (int) rect86.getRectangle().y;
										spawn1.x = playerx;
										spawn1.y = playery;
										
										RectangleMapObject rect87 = (RectangleMapObject) layer.getObjects().get("spalt1");
										playerx = (int) rect87.getRectangle().x;
										playery = (int) rect87.getRectangle().y;
										spawn2.x = playerx;
										spawn2.y = playery;
										
										RectangleMapObject rect88 = (RectangleMapObject) layer.getObjects().get("spalt2");
										playerx = (int) rect88.getRectangle().x;
										playery = (int) rect88.getRectangle().y;
										spawn3.x = playerx;
										spawn3.y = playery;
										
										RectangleMapObject rect89 = (RectangleMapObject) layer.getObjects().get("spalt3");
										playerx = (int) rect89.getRectangle().x;
										playery = (int) rect89.getRectangle().y;
										spawn4.x = playerx;
										spawn4.y = playery;
										
										RectangleMapObject rect90 = (RectangleMapObject) layer.getObjects().get("spalt4");
										playerx = (int) rect90.getRectangle().x;
										playery = (int) rect90.getRectangle().y;
										spawn5.x = playerx;
										spawn5.y = playery;
										
										RectangleMapObject rect91 = (RectangleMapObject) layer.getObjects().get("spalt5");
										playerx = (int) rect91.getRectangle().x;
										playery = (int) rect91.getRectangle().y;
										spawn6.x = playerx;
										spawn6.y = playery;
										
										RectangleMapObject rect92 = (RectangleMapObject) layer.getObjects().get("spalt6");
										playerx = (int) rect92.getRectangle().x;
										playery = (int) rect92.getRectangle().y;
										spawn7.x = playerx;
										spawn7.y = playery;
										
										RectangleMapObject rect93 = (RectangleMapObject) layer.getObjects().get("spalt7");
										playerx = (int) rect93.getRectangle().x;
										playery = (int) rect93.getRectangle().y;
										spawn8.x = playerx;
										spawn8.y = playery;
										
										RectangleMapObject rect94 = (RectangleMapObject) layer.getObjects().get("spalt8");
										playerx = (int) rect94.getRectangle().x;
										playery = (int) rect94.getRectangle().y;
										spawn9.x = playerx;
										spawn9.y = playery;
										
										RectangleMapObject rect95 = (RectangleMapObject) layer.getObjects().get("spalt9");
										playerx = (int) rect95.getRectangle().x;
										playery = (int) rect95.getRectangle().y;
										spawn10.x = playerx;
										spawn10.y = playery;
										
										RectangleMapObject rect96 = (RectangleMapObject) layer.getObjects().get("spalt0");
										playerx = (int) rect96.getRectangle().x;
										playery = (int) rect96.getRectangle().y;
										spawn11.x = playerx;
										spawn11.y = playery;
										
										RectangleMapObject rect97 = (RectangleMapObject) layer.getObjects().get("spalt10");
										playerx = (int) rect97.getRectangle().x;
										playery = (int) rect97.getRectangle().y;
										spawn12.x = playerx;
										spawn12.y = playery;
										
										RectangleMapObject rect98 = (RectangleMapObject) layer.getObjects().get("spalt11");
			...
			case "maps/IF2.tmx": 		RectangleMapObject rect99 = (RectangleMapObject) layer.getObjects().get("spwa");
										playerx = (int) rect99.getRectangle().x;
										playery = (int) rect99.getRectangle().y;
										spawn1.x = playerx;
										spawn1.y = playery;
							
										RectangleMapObject rect100 = (RectangleMapObject) layer.getObjects().get("spsz");
										playerx = (int) rect100.getRectangle().x;
										playery = (int) rect100.getRectangle().y;
										spawn2.x = playerx;
										spawn2.y = playery;
							
										RectangleMapObject rect101 = (RectangleMapObject) layer.getObjects().get("spca1");
										playerx = (int) rect101.getRectangle().x;
										playery = (int) rect101.getRectangle().y;
										spawn3.x = playerx;
										spawn3.y = playery;
							
										RectangleMapObject rect102 = (RectangleMapObject) layer.getObjects().get("spca2");
										playerx = (int) rect102.getRectangle().x;
										playery = (int) rect102.getRectangle().y;
										spawn4.x = playerx;
										spawn4.y = playery;
							
										RectangleMapObject rect103 = (RectangleMapObject) layer.getObjects().get("spif1");
										playerx = (int) rect103.getRectangle().x;
										playery = (int) rect103.getRectangle().y;
										spawn5.x = playerx;
										spawn5.y = playery;
							
										RectangleMapObject rect104 = (RectangleMapObject) layer.getObjects().get("spif2");
										playerx = (int) rect104.getRectangle().x;
										playery = (int) rect104.getRectangle().y;
										spawn6.x = playerx;
										spawn6.y = playery;
							
										RectangleMapObject rect105 = (RectangleMapObject) layer.getObjects().get("spif3");
										playerx = (int) rect105.getRectangle().x;
										playery = (int) rect105.getRectangle().y;
										spawn7.x = playerx;
										spawn7.y = playery;
							
										RectangleMapObject rect106 = (RectangleMapObject) layer.getObjects().get("spif4");
										playerx = (int) rect106.getRectangle().x;
										playery = (int) rect106.getRectangle().y;
										spawn8.x = playerx;
										spawn8.y = playery;
							
										RectangleMapObject rect107 = (RectangleMapObject) layer.getObjects().get("spif5");
										playerx = (int) rect107.getRectangle().x;
										playery = (int) rect107.getRectangle().y;
										spawn9.x = playerx;
										spawn9.y = playery;
							
										RectangleMapObject rect108 = (RectangleMapObject) layer.getObjects().get("spif6");
										playerx = (int) rect108.getRectangle().x;
										playery = (int) rect108.getRectangle().y;
										spawn10.x = playerx;
										spawn10.y = playery;
							
										RectangleMapObject rect109 = (RectangleMapObject) layer.getObjects().get("spif7");
										playerx = (int) rect109.getRectangle().x;
										playery = (int) rect109.getRectangle().y;
										spawn11.x = playerx;
										spawn11.y = playery;
							
										RectangleMapObject rect110 = (RectangleMapObject) layer.getObjects().get("spif8");
										playerx = (int) rect110.getRectangle().x;
										playery = (int) rect110.getRectangle().y;
										spawn12.x = playerx;
										spawn12.y = playery;
							
										RectangleMapObject rect111 = (RectangleMapObject) layer.getObjects().get("spif9");
										playerx = (int) rect111.getRectangle().x;
										playery = (int) rect111.getRectangle().y;
										spawn13.x = playerx;
										spawn13.y = playery;
							
										RectangleMapObject rect112 = (RectangleMapObject) layer.getObjects().get("spif10");
										playerx = (int) rect112.getRectangle().x;
										playery = (int) rect112.getRectangle().y;
										spawn14.x = playerx;
										spawn14.y = playery;
							
										RectangleMapObject rect113 = (RectangleMapObject) layer.getObjects().get("spif11");
										playerx = (int) rect113.getRectangle().x;
										playery = (int) rect113.getRectangle().y;
										spawn15.x = playerx;
										spawn15.y = playery;
							
										RectangleMapObject rect114 = (RectangleMapObject) layer.getObjects().get("spif12");
										playerx = (int) rect114.getRectangle().x;
										playery = (int) rect114.getRectangle().y;
										spawn16.x = playerx;
										spawn16.y = playery;
							
										RectangleMapObject rect115 = (RectangleMapObject) layer.getObjects().get("spif13");
										playerx = (int) rect115.getRectangle().x;
										playery = (int) rect115.getRectangle().y;
										spawn17.x = playerx;
										spawn17.y = playery;
							
										RectangleMapObject rect116 = (RectangleMapObject) layer.getObjects().get("spif14");
										playerx = (int) rect116.getRectangle().x;
										playery = (int) rect116.getRectangle().y;
										spawn18.x = playerx;
										spawn18.y = playery;
							
										RectangleMapObject rect117 = (RectangleMapObject) layer.getObjects().get("spif15");
										playerx = (int) rect117.getRectangle().x;
										playery = (int) rect117.getRectangle().y;
										spawn19.x = playerx;
										spawn19.y = playery;
							
										RectangleMapObject rect118 = (RectangleMapObject) layer.getObjects().get("spif16");
										playerx = (int) rect118.getRectangle().x;
										playery = (int) rect118.getRectangle().y;
										spawn20.x = playerx;
										spawn20.y = playery;
							
										RectangleMapObject rect119 = (RectangleMapObject) layer.getObjects().get("spif17");
										playerx = (int) rect119.getRectangle().x;
										playery = (int) rect119.getRectangle().y;
										spawn21.x = playerx;
										spawn21.y = playery;
							
										RectangleMapObject rect120 = (RectangleMapObject) layer.getObjects().get("spif18");
										playerx = (int) rect120.getRectangle().x;
										playery = (int) rect120.getRectangle().y;
										spawn22.x = playerx;
										spawn22.y = playery;
							
										RectangleMapObject rect121 = (RectangleMapObject) layer.getObjects().get("spif19");
										playerx = (int) rect121.getRectangle().x;
										playery = (int) rect121.getRectangle().y;
										spawn23.x = playerx;
										spawn23.y = playery;
							
										RectangleMapObject rect122 = (RectangleMapObject) layer.getObjects().get("spif20");
										playerx = (int) rect122.getRectangle().x;
										playery = (int) rect122.getRectangle().y;
										spawn24.x = playerx;
										spawn24.y = playery;
										
										RectangleMapObject rect158 = (RectangleMapObject) layer.getObjects().get("spalt");
			...
			case "maps/ho.tmx": 		RectangleMapObject rect123 = (RectangleMapObject) layer.getObjects().get("spho");
										playerx = (int) rect123.getRectangle().x;
										playery = (int) rect123.getRectangle().y;
										spawn1.x = playerx;
										spawn1.y = playery;
										
										RectangleMapObject rect124 = (RectangleMapObject) layer.getObjects().get("spho1");
										playerx = (int) rect124.getRectangle().x;
										playery = (int) rect124.getRectangle().y;
										spawn2.x = playerx;
										spawn2.y = playery;
										
										RectangleMapObject rect125 = (RectangleMapObject) layer.getObjects().get("spho2");
										playerx = (int) rect125.getRectangle().x;
										playery = (int) rect125.getRectangle().y;
										spawn3.x = playerx;
										spawn3.y = playery;
										
										RectangleMapObject rect126 = (RectangleMapObject) layer.getObjects().get("spho3");
										playerx = (int) rect126.getRectangle().x;
										playery = (int) rect126.getRectangle().y;
										spawn4.x = playerx;
										spawn4.y = playery;
										
										RectangleMapObject rect127 = (RectangleMapObject) layer.getObjects().get("spho4");
										playerx = (int) rect127.getRectangle().x;
										playery = (int) rect127.getRectangle().y;
										spawn5.x = playerx;
										spawn5.y = playery;
										
										RectangleMapObject rect128 = (RectangleMapObject) layer.getObjects().get("spho5");
										playerx = (int) rect128.getRectangle().x;
										playery = (int) rect128.getRectangle().y;
										spawn6.x = playerx;
										spawn6.y = playery;
										
										RectangleMapObject rect129 = (RectangleMapObject) layer.getObjects().get("spho6");
										playerx = (int) rect129.getRectangle().x;
										playery = (int) rect129.getRectangle().y;
										spawn7.x = playerx;
										spawn7.y = playery;
										
										RectangleMapObject rect130 = (RectangleMapObject) layer.getObjects().get("spho7");
										playerx = (int) rect130.getRectangle().x;
										playery = (int) rect130.getRectangle().y;
										spawn8.x = playerx;
										spawn8.y = playery;
										
										RectangleMapObject rect131 = (RectangleMapObject) layer.getObjects().get("spho8");
										playerx = (int) rect131.getRectangle().x;
										playery = (int) rect131.getRectangle().y;
										spawn9.x = playerx;
										spawn9.y = playery;
										
										RectangleMapObject rect132 = (RectangleMapObject) layer.getObjects().get("spho9");
										playerx = (int) rect132.getRectangle().x;
										playery = (int) rect132.getRectangle().y;
										spawn10.x = playerx;
										spawn10.y = playery;
										
										RectangleMapObject rect133 = (RectangleMapObject) layer.getObjects().get("spho10");
										playerx = (int) rect133.getRectangle().x;
										playery = (int) rect133.getRectangle().y;
										spawn11.x = playerx;
										spawn11.y = playery;
										
										RectangleMapObject rect134 = (RectangleMapObject) layer.getObjects().get("spho11");
										playerx = (int) rect134.getRectangle().x;
										playery = (int) rect134.getRectangle().y;
										spawn12.x = playerx;
										spawn12.y = playery;
										
										RectangleMapObject rect135 = (RectangleMapObject) layer.getObjects().get("spho12");
										playerx = (int) rect135.getRectangle().x;
										playery = (int) rect135.getRectangle().y;
										spawn13.x = playerx;
										spawn13.y = playery;
										
										RectangleMapObject rect136 = (RectangleMapObject) layer.getObjects().get("spho13");
										playerx = (int) rect136.getRectangle().x;
										playery = (int) rect136.getRectangle().y;
										spawn14.x = playerx;
										spawn14.y = playery;
										
										RectangleMapObject rect137 = (RectangleMapObject) layer.getObjects().get("spho14");
										playerx = (int) rect137.getRectangle().x;
										playery = (int) rect137.getRectangle().y;
										spawn15.x = playerx;
										spawn15.y = playery;
										
										RectangleMapObject rect138 = (RectangleMapObject) layer.getObjects().get("spho15");
										playerx = (int) rect138.getRectangle().x;
										playery = (int) rect138.getRectangle().y;
										spawn16.x = playerx;
										spawn16.y = playery;
										
										RectangleMapObject rect139 = (RectangleMapObject) layer.getObjects().get("spho16");
										playerx = (int) rect139.getRectangle().x;
										playery = (int) rect139.getRectangle().y;
										spawn17.x = playerx;
										spawn17.y = playery;
										
										RectangleMapObject rect140 = (RectangleMapObject) layer.getObjects().get("spho17");
										playerx = (int) rect140.getRectangle().x;
										playery = (int) rect140.getRectangle().y;
										spawn18.x = playerx;
										spawn18.y = playery;
										
										RectangleMapObject rect141 = (RectangleMapObject) layer.getObjects().get("spho18");
										playerx = (int) rect141.getRectangle().x;
										playery = (int) rect141.getRectangle().y;
										spawn19.x = playerx;
										spawn19.y = playery;
										
										RectangleMapObject rect142 = (RectangleMapObject) layer.getObjects().get("spho19");
										playerx = (int) rect142.getRectangle().x;
										playery = (int) rect142.getRectangle().y;
										spawn20.x = playerx;
										spawn20.y = playery;
										
										RectangleMapObject rect143 = (RectangleMapObject) layer.getObjects().get("spho20");
										playerx = (int) rect143.getRectangle().x;
										playery = (int) rect143.getRectangle().y;
										spawn21.x = playerx;
										spawn21.y = playery;
										
										RectangleMapObject rect144 = (RectangleMapObject) layer.getObjects().get("spho21");
										playerx = (int) rect144.getRectangle().x;
										playery = (int) rect144.getRectangle().y;
										spawn22.x = playerx;
										spawn22.y = playery;
										
										RectangleMapObject rect145 = (RectangleMapObject) layer.getObjects().get("spho22");
										playerx = (int) rect145.getRectangle().x;
										playery = (int) rect145.getRectangle().y;
										spawn23.x = playerx;
										spawn23.y = playery;
										
										RectangleMapObject rect146 = (RectangleMapObject) layer.getObjects().get("spho23");
										playerx = (int) rect146.getRectangle().x;
										playery = (int) rect146.getRectangle().y;
										spawn24.x = playerx;
										spawn24.y = playery;
										
										RectangleMapObject rect147 = (RectangleMapObject) layer.getObjects().get("spho24");
			...
			case "maps/maze.tmx": 		RectangleMapObject rect148 = (RectangleMapObject) layer.getObjects().get("spla1");
										playerx = (int) rect148.getRectangle().x;
										playery = (int) rect148.getRectangle().y;
										spawn1.x = playerx;
										spawn1.y = playery;
										
										RectangleMapObject rect149 = (RectangleMapObject) layer.getObjects().get("spla2");
										playerx = (int) rect149.getRectangle().x;
										playery = (int) rect149.getRectangle().y;
										spawn2.x = playerx;
										spawn2.y = playery;
										
										RectangleMapObject rect150 = (RectangleMapObject) layer.getObjects().get("spla3");
										playerx = (int) rect150.getRectangle().x;
										playery = (int) rect150.getRectangle().y;
										spawn3.x = playerx;
										spawn3.y = playery;
										
										RectangleMapObject rect151 = (RectangleMapObject) layer.getObjects().get("spla4");
										playerx = (int) rect151.getRectangle().x;
										playery = (int) rect151.getRectangle().y;
										spawn4.x = playerx;
										spawn4.y = playery;
										
										RectangleMapObject rect152 = (RectangleMapObject) layer.getObjects().get("spla5");
			...
			case "maps/leonswohnung.tmx": 	RectangleMapObject rect153 = (RectangleMapObject) layer.getObjects().get("spwa");
											playerx = (int) rect153.getRectangle().x;
											playery = (int) rect153.getRectangle().y;
											spawn1.x = playerx;
											spawn1.y = playery;
							
											RectangleMapObject rect154 = (RectangleMapObject) layer.getObjects().get("spwo1");
											playerx = (int) rect154.getRectangle().x;
											playery = (int) rect154.getRectangle().y;
											spawn2.x = playerx;
											spawn2.y = playery;
							
											RectangleMapObject rect155 = (RectangleMapObject) layer.getObjects().get("spwo2");
	...
	public void getExitpoints(){
		...
		switch(map){
			case "maps/demondus1.tmx":	RectangleMapObject exitrect1 = (RectangleMapObject) Exitlayer.getObjects().get("exde2");
			...
			case "maps/demondus2.tmx":	RectangleMapObject exitrect4 = (RectangleMapObject) Exitlayer.getObjects().get("exitpoint1");
			...
			case "maps/room.tmx":		RectangleMapObject exitrect7 = (RectangleMapObject) Exitlayer.getObjects().get("exrode2");
			...
			case "maps/demondus3.tmx":	RectangleMapObject exitrect18 = (RectangleMapObject) Exitlayer.getObjects().get("exde2");
			...
			case "maps/demondus4.tmx":	RectangleMapObject exitrect22 = (RectangleMapObject) Exitlayer.getObjects().get("exde3");
			...
			case "maps/demondus5.tmx":	RectangleMapObject exitrect25 = (RectangleMapObject) Exitlayer.getObjects().get("excade4");
										exit1 = exitrect25.getRectangle();
			break;
			
			case "maps/wehhh.tmx":		RectangleMapObject exitrect26 = (RectangleMapObject) Exitlayer.getObjects().get("exsede3");
										exit1 = exitrect26.getRectangle();
			break;
			
			case "maps/demondus7.tmx":	RectangleMapObject exitrect27 = (RectangleMapObject) Exitlayer.getObjects().get("exde3");
			...
			case "maps/demondusdorf.tmx":	RectangleMapObject exitrect29 = (RectangleMapObject) Exitlayer.getObjects().get("exde7");
			...
			case "maps/kathedrale.tmx":	RectangleMapObject exitrect34 = (RectangleMapObject) Exitlayer.getObjects().get("exdd");
			...
			case "maps/Dach_Tag.tmx":	RectangleMapObject exitrect47 = (RectangleMapObject) Exitlayer.getObjects().get("exdach");
										exit1 = exitrect47.getRectangle();										
			break;
			
			case "maps/Dach_Nacht.tmx":	RectangleMapObject exitrect48 = (RectangleMapObject) Exitlayer.getObjects().get("exdach");
										exit1 = exitrect48.getRectangle();										
			break;
			
			case "maps/Hauptweg_Tag.tmx": RectangleMapObject exitrect49 = (RectangleMapObject) Exitlayer.getObjects().get("exwo");
											exit1 = exitrect49.getRectangle();
											
											RectangleMapObject exitrect50 = (RectangleMapObject) Exitlayer.getObjects().get("exwese");
											exit2 = exitrect50.getRectangle();
											
											RectangleMapObject exitrect51 = (RectangleMapObject) Exitlayer.getObjects().get("exhof");
											exit3 = exitrect51.getRectangle();
											
											RectangleMapObject exitrect52 = (RectangleMapObject) Exitlayer.getObjects().get("exlich");
											exit4 = exitrect52.getRectangle();
			break;
			
			case "maps/Hauptweg_Nacht.tmx": RectangleMapObject exitrect53 = (RectangleMapObject) Exitlayer.getObjects().get("exwo");
											exit1 = exitrect53.getRectangle();
											
											RectangleMapObject exitrect54 = (RectangleMapObject) Exitlayer.getObjects().get("exwese");
											exit2 = exitrect54.getRectangle();
											
											RectangleMapObject exitrect55 = (RectangleMapObject) Exitlayer.getObjects().get("exhof");
											exit3 = exitrect55.getRectangle();
											
											RectangleMapObject exitrect56 = (RectangleMapObject) Exitlayer.getObjects().get("exlich");
											exit4 = exitrect56.getRectangle();
	    	break;
	    	
			case "maps/Lichtung_Tag.tmx":	RectangleMapObject exitrect57 = (RectangleMapObject) Exitlayer.getObjects().get("exhawe");
											exit1 = exitrect57.getRectangle();
											
											RectangleMapObject exitrect58 = (RectangleMapObject) Exitlayer.getObjects().get("exwo");
											exit2 = exitrect58.getRectangle();
			break;
			
			case "maps/Lichtung_Nacht.tmx":	RectangleMapObject exitrect59 = (RectangleMapObject) Exitlayer.getObjects().get("exhawe");
											exit1 = exitrect59.getRectangle();
											
											RectangleMapObject exitrect60 = (RectangleMapObject) Exitlayer.getObjects().get("exwo");
											exit2 = exitrect60.getRectangle();
			break;
			
			case "maps/See_Tag.tmx":		RectangleMapObject exitrect61 = (RectangleMapObject) Exitlayer.getObjects().get("exwese");
											exit1 = exitrect61.getRectangle();
			break;
			
			case "maps/See_Nacht.tmx":		RectangleMapObject exitrect62 = (RectangleMapObject) Exitlayer.getObjects().get("exwese");
											exit1 = exitrect62.getRectangle();
			break;
			
			case "maps/WegZumSee_Tag.tmx":	RectangleMapObject exitrect63 = (RectangleMapObject) Exitlayer.getObjects().get("exhawe");
											exit1 = exitrect63.getRectangle();
											
											RectangleMapObject exitrect64 = (RectangleMapObject) Exitlayer.getObjects().get("exsee");
											exit2 = exitrect64.getRectangle();
			break;
			
			case "maps/WegZumSee_Nacht.tmx":	RectangleMapObject exitrect65 = (RectangleMapObject) Exitlayer.getObjects().get("exhawe");
											exit1 = exitrect65.getRectangle();
											
											RectangleMapObject exitrect66 = (RectangleMapObject) Exitlayer.getObjects().get("exsee");
											exit2 = exitrect66.getRectangle();
			break;
			
			case "maps/Sozialzweig.tmx":	RectangleMapObject exitrect67 = (RectangleMapObject) Exitlayer.getObjects().get("exho1");
											exit1 = exitrect67.getRectangle();
											
											RectangleMapObject exitrect68 = (RectangleMapObject) Exitlayer.getObjects().get("exho2");
											exit2 = exitrect68.getRectangle();
											
											RectangleMapObject exitrect69 = (RectangleMapObject) Exitlayer.getObjects().get("exdach");
											exit3 = exitrect69.getRectangle();
											
											RectangleMapObject exitrect70 = (RectangleMapObject) Exitlayer.getObjects().get("exbi1");
											exit4 = exitrect70.getRectangle();
											
											RectangleMapObject exitrect71 = (RectangleMapObject) Exitlayer.getObjects().get("exbi2");
											exit5 = exitrect71.getRectangle();
											
											RectangleMapObject exitrect72 = (RectangleMapObject) Exitlayer.getObjects().get("exeg");
											exit6 = exitrect72.getRectangle();
											
											RectangleMapObject exitrect73 = (RectangleMapObject) Exitlayer.getObjects().get("exbib1");
											exit7 = exitrect73.getRectangle();
											
											RectangleMapObject exitrect74 = (RectangleMapObject) Exitlayer.getObjects().get("exbib2");
											exit8 = exitrect74.getRectangle();
											
											RectangleMapObject exitrect75 = (RectangleMapObject) Exitlayer.getObjects().get("exbiug");
											exit9 = exitrect75.getRectangle();
											
											RectangleMapObject exitrect76 = (RectangleMapObject) Exitlayer.getObjects().get("ex1s");
											exit10 = exitrect76.getRectangle();
											
											RectangleMapObject exitrect77 = (RectangleMapObject) Exitlayer.getObjects().get("ex12s");
											exit11 = exitrect77.getRectangle();
											
											RectangleMapObject exitrect78 = (RectangleMapObject) Exitlayer.getObjects().get("ex2s");
											exit12 = exitrect78.getRectangle();
											
											RectangleMapObject exitrect79 = (RectangleMapObject) Exitlayer.getObjects().get("exbiog");
											exit13 = exitrect79.getRectangle();
			break;
			
			case "maps/cafeteria.tmx":		RectangleMapObject exitrect80 = (RectangleMapObject) Exitlayer.getObjects().get("excake");
											exit1 = exitrect80.getRectangle();
											
											RectangleMapObject exitrect81 = (RectangleMapObject) Exitlayer.getObjects().get("exkeca");
											exit2 = exitrect81.getRectangle();
											
											RectangleMapObject exitrect82 = (RectangleMapObject) Exitlayer.getObjects().get("exroca");
											exit3 = exitrect82.getRectangle();
											
											RectangleMapObject exitrect83 = (RectangleMapObject) Exitlayer.getObjects().get("excaro");
											exit4 = exitrect83.getRectangle();
											
											RectangleMapObject exitrect84 = (RectangleMapObject) Exitlayer.getObjects().get("exca");
											exit5 = exitrect84.getRectangle();
											
											RectangleMapObject exitrect85 = (RectangleMapObject) Exitlayer.getObjects().get("excaif");
											exit6 = exitrect85.getRectangle();
											
											RectangleMapObject exitrect86 = (RectangleMapObject) Exitlayer.getObjects().get("exke");
											exit7 = exitrect86.getRectangle();
			break;
			
			case "maps/altbau.tmx":		RectangleMapObject exitrect87 = (RectangleMapObject) Exitlayer.getObjects().get("exif2");
										exit1 = exitrect87.getRectangle();
										
										RectangleMapObject exitrect88 = (RectangleMapObject) Exitlayer.getObjects().get("exalt1");
										exit2 = exitrect88.getRectangle();
										
										RectangleMapObject exitrect89 = (RectangleMapObject) Exitlayer.getObjects().get("exalt2");
										exit3 = exitrect89.getRectangle();
										
										RectangleMapObject exitrect90 = (RectangleMapObject) Exitlayer.getObjects().get("exalt3");
										exit4 = exitrect90.getRectangle();
										
										RectangleMapObject exitrect91 = (RectangleMapObject) Exitlayer.getObjects().get("exalt4");
										exit5 = exitrect91.getRectangle();
										
										RectangleMapObject exitrect92 = (RectangleMapObject) Exitlayer.getObjects().get("exalt5");
										exit6 = exitrect92.getRectangle();
										
										RectangleMapObject exitrect93 = (RectangleMapObject) Exitlayer.getObjects().get("exalt6");
										exit7 = exitrect93.getRectangle();
										
										RectangleMapObject exitrect94 = (RectangleMapObject) Exitlayer.getObjects().get("exalt7");
										exit8 = exitrect94.getRectangle();
										
										RectangleMapObject exitrect95 = (RectangleMapObject) Exitlayer.getObjects().get("exalt8");
										exit9 = exitrect95.getRectangle();
										
										RectangleMapObject exitrect96 = (RectangleMapObject) Exitlayer.getObjects().get("exalt9");
										exit10 = exitrect96.getRectangle();
										
										RectangleMapObject exitrect97 = (RectangleMapObject) Exitlayer.getObjects().get("exalt0");
										exit11 = exitrect97.getRectangle();
										
										RectangleMapObject exitrect98 = (RectangleMapObject) Exitlayer.getObjects().get("exalt10");
										exit12 = exitrect98.getRectangle();
										
										RectangleMapObject exitrect99 = (RectangleMapObject) Exitlayer.getObjects().get("exalt11");
										exit13 = exitrect99.getRectangle();
			break;
			
			case "maps/IF2.tmx":		RectangleMapObject exitrect100 = (RectangleMapObject) Exitlayer.getObjects().get("exwa");
										exit1 = exitrect100.getRectangle();	
							
										RectangleMapObject exitrect101 = (RectangleMapObject) Exitlayer.getObjects().get("exsz");
										exit2 = exitrect101.getRectangle();		
										
										RectangleMapObject exitrect102 = (RectangleMapObject) Exitlayer.getObjects().get("exca1");
										exit3 = exitrect102.getRectangle();		
										
										RectangleMapObject exitrect103 = (RectangleMapObject) Exitlayer.getObjects().get("exca2");
										exit4 = exitrect103.getRectangle();		
										
										RectangleMapObject exitrect104 = (RectangleMapObject) Exitlayer.getObjects().get("exif1");
										exit5 = exitrect104.getRectangle();		
										
										RectangleMapObject exitrect105 = (RectangleMapObject) Exitlayer.getObjects().get("exif2");
										exit6 = exitrect105.getRectangle();
							
										RectangleMapObject exitrect106 = (RectangleMapObject) Exitlayer.getObjects().get("exif3");
										exit7 = exitrect106.getRectangle();		
										
										RectangleMapObject exitrect107 = (RectangleMapObject) Exitlayer.getObjects().get("exif4");
										exit8 = exitrect107.getRectangle();		
										
										RectangleMapObject exitrect108 = (RectangleMapObject) Exitlayer.getObjects().get("exif5");
										exit9 = exitrect108.getRectangle();		
										
										RectangleMapObject exitrect109 = (RectangleMapObject) Exitlayer.getObjects().get("exif6");
										exit10 = exitrect109.getRectangle();		
										
										RectangleMapObject exitrect110 = (RectangleMapObject) Exitlayer.getObjects().get("exif7");
										exit11 = exitrect110.getRectangle();		
										
										RectangleMapObject exitrect111 = (RectangleMapObject) Exitlayer.getObjects().get("exif8");
										exit12 = exitrect111.getRectangle();		
										
										RectangleMapObject exitrect112 = (RectangleMapObject) Exitlayer.getObjects().get("exif9");
										exit13 = exitrect112.getRectangle();		
										
										RectangleMapObject exitrect113 = (RectangleMapObject) Exitlayer.getObjects().get("exif10");
										exit14 = exitrect113.getRectangle();		
										
										RectangleMapObject exitrect114 = (RectangleMapObject) Exitlayer.getObjects().get("exif11");
										exit15 = exitrect114.getRectangle();		
										
										RectangleMapObject exitrect115 = (RectangleMapObject) Exitlayer.getObjects().get("exif12");
										exit16 = exitrect115.getRectangle();		
										
										RectangleMapObject exitrect116 = (RectangleMapObject) Exitlayer.getObjects().get("exif13");
										exit17 = exitrect116.getRectangle();		
										
										RectangleMapObject exitrect117 = (RectangleMapObject) Exitlayer.getObjects().get("exif14");
										exit18 = exitrect117.getRectangle();		
										
										RectangleMapObject exitrect118 = (RectangleMapObject) Exitlayer.getObjects().get("exif15");
										exit19 = exitrect118.getRectangle();		
										
										RectangleMapObject exitrect119 = (RectangleMapObject) Exitlayer.getObjects().get("exif16");
										exit20 = exitrect119.getRectangle();		
										
										RectangleMapObject exitrect120 = (RectangleMapObject) Exitlayer.getObjects().get("exif17");
										exit21 = exitrect120.getRectangle();		
										
										RectangleMapObject exitrect121 = (RectangleMapObject) Exitlayer.getObjects().get("exif18");
										exit22 = exitrect121.getRectangle();		
										
										RectangleMapObject exitrect122 = (RectangleMapObject) Exitlayer.getObjects().get("exif19");
										exit23 = exitrect122.getRectangle();		
										
										RectangleMapObject exitrect123 = (RectangleMapObject) Exitlayer.getObjects().get("exif20");
										exit24 = exitrect123.getRectangle();
										
										RectangleMapObject exitrect169 = (RectangleMapObject) Exitlayer.getObjects().get("exalt");
										exit25 = exitrect169.getRectangle();
			break;
			
			case "maps/ho.tmx":		RectangleMapObject exitrect124 = (RectangleMapObject) Exitlayer.getObjects().get("exho1");
									exit1 = exitrect124.getRectangle();								
									
									RectangleMapObject exitrect125 = (RectangleMapObject) Exitlayer.getObjects().get("exho2");
									exit2 = exitrect125.getRectangle();								
									
									RectangleMapObject exitrect126 = (RectangleMapObject) Exitlayer.getObjects().get("exho3");
									exit3 = exitrect126.getRectangle();								
									
									RectangleMapObject exitrect127 = (RectangleMapObject) Exitlayer.getObjects().get("exho4");
									exit4 = exitrect127.getRectangle();								
									
									RectangleMapObject exitrect128 = (RectangleMapObject) Exitlayer.getObjects().get("exho5");
									exit5 = exitrect128.getRectangle();								
									
									RectangleMapObject exitrect1282 = (RectangleMapObject) Exitlayer.getObjects().get("exho6");
									exit6 = exitrect1282.getRectangle();								
									
									RectangleMapObject exitrect1283 = (RectangleMapObject) Exitlayer.getObjects().get("exho7");
									exit7 = exitrect1283.getRectangle();								
									
									RectangleMapObject exitrect129 = (RectangleMapObject) Exitlayer.getObjects().get("exho8");
									exit8 = exitrect129.getRectangle();								
									
									RectangleMapObject exitrect130 = (RectangleMapObject) Exitlayer.getObjects().get("exho9");
									exit9 = exitrect130.getRectangle();								
									
									RectangleMapObject exitrect131 = (RectangleMapObject) Exitlayer.getObjects().get("exho10");
									exit10 = exitrect131.getRectangle();								
									
									RectangleMapObject exitrect132 = (RectangleMapObject) Exitlayer.getObjects().get("exho11");
									exit11 = exitrect132.getRectangle();								
									
									RectangleMapObject exitrect133 = (RectangleMapObject) Exitlayer.getObjects().get("exho12");
									exit12 = exitrect133.getRectangle();								
									
									RectangleMapObject exitrect134 = (RectangleMapObject) Exitlayer.getObjects().get("exho13");
									exit13 = exitrect134.getRectangle();								
									
									RectangleMapObject exitrect135 = (RectangleMapObject) Exitlayer.getObjects().get("exho14");
									exit14 = exitrect135.getRectangle();								
									
									RectangleMapObject exitrect136 = (RectangleMapObject) Exitlayer.getObjects().get("exho15");
									exit15 = exitrect136.getRectangle();								
									
									RectangleMapObject exitrect137 = (RectangleMapObject) Exitlayer.getObjects().get("exho16");
									exit16 = exitrect137.getRectangle();								
									
									RectangleMapObject exitrect138 = (RectangleMapObject) Exitlayer.getObjects().get("exho17");
									exit17 = exitrect138.getRectangle();								
									
									RectangleMapObject exitrect139 = (RectangleMapObject) Exitlayer.getObjects().get("exho18");
									exit18 = exitrect139.getRectangle();								
									
									RectangleMapObject exitrect140 = (RectangleMapObject) Exitlayer.getObjects().get("exho19");
									exit19 = exitrect140.getRectangle();								
									
									RectangleMapObject exitrect141 = (RectangleMapObject) Exitlayer.getObjects().get("exho20");
									exit20 = exitrect141.getRectangle();								
									
									RectangleMapObject exitrect142 = (RectangleMapObject) Exitlayer.getObjects().get("exho21");
									exit21 = exitrect142.getRectangle();								
									
									RectangleMapObject exitrect143 = (RectangleMapObject) Exitlayer.getObjects().get("exho22");
									exit22 = exitrect143.getRectangle();								
									
									RectangleMapObject exitrect144 = (RectangleMapObject) Exitlayer.getObjects().get("exho23");
									exit23 = exitrect144.getRectangle();								
									
									RectangleMapObject exitrect145 = (RectangleMapObject) Exitlayer.getObjects().get("exho24");
									exit24 = exitrect145.getRectangle();
			break;
			
			case "maps/maze.tmx":		RectangleMapObject exitrect146 = (RectangleMapObject) Exitlayer.getObjects().get("exlar1");
										exit1 = exitrect146.getRectangle();	
							
										RectangleMapObject exitrect147 = (RectangleMapObject) Exitlayer.getObjects().get("exlar2");
										exit2 = exitrect147.getRectangle();								
										
										RectangleMapObject exitrect148 = (RectangleMapObject) Exitlayer.getObjects().get("exlar3");
										exit3 = exitrect148.getRectangle();								
										
										RectangleMapObject exitrect149 = (RectangleMapObject) Exitlayer.getObjects().get("exlar4");
										exit4 = exitrect149.getRectangle();			
							
										RectangleMapObject exitrect150 = (RectangleMapObject) Exitlayer.getObjects().get("exlar5");
										exit5 = exitrect150.getRectangle();								
										
										RectangleMapObject exitrect151 = (RectangleMapObject) Exitlayer.getObjects().get("exla1");
										exit6 = exitrect151.getRectangle();								
										
										RectangleMapObject exitrect152 = (RectangleMapObject) Exitlayer.getObjects().get("exla2");
										exit7 = exitrect152.getRectangle();								
										
										RectangleMapObject exitrect153 = (RectangleMapObject) Exitlayer.getObjects().get("exla3");
										exit8 = exitrect153.getRectangle();								
										
										RectangleMapObject exitrect154 = (RectangleMapObject) Exitlayer.getObjects().get("exla4");
										exit9 = exitrect154.getRectangle();								
										
										RectangleMapObject exitrect155 = (RectangleMapObject) Exitlayer.getObjects().get("exla5");
										exit10 = exitrect155.getRectangle();								
										
										RectangleMapObject exitrect156 = (RectangleMapObject) Exitlayer.getObjects().get("exla6");
										exit11 = exitrect156.getRectangle();								
										
										RectangleMapObject exitrect157 = (RectangleMapObject) Exitlayer.getObjects().get("exla7");
										exit12 = exitrect157.getRectangle();								
										
										RectangleMapObject exitrect158 = (RectangleMapObject) Exitlayer.getObjects().get("exla8");
										exit13 = exitrect158.getRectangle();								
										
										RectangleMapObject exitrect159 = (RectangleMapObject) Exitlayer.getObjects().get("exla9");
										exit14 = exitrect159.getRectangle();								
										
										RectangleMapObject exitrect160 = (RectangleMapObject) Exitlayer.getObjects().get("exla10");
										exit15 = exitrect160.getRectangle();								
										
										RectangleMapObject exitrect161 = (RectangleMapObject) Exitlayer.getObjects().get("exla11");
										exit16 = exitrect161.getRectangle();								
										
										RectangleMapObject exitrect162 = (RectangleMapObject) Exitlayer.getObjects().get("exla12");
										exit17 = exitrect162.getRectangle();								
										
										RectangleMapObject exitrect163 = (RectangleMapObject) Exitlayer.getObjects().get("exla13");
										exit18 = exitrect163.getRectangle();								
										
										RectangleMapObject exitrect164 = (RectangleMapObject) Exitlayer.getObjects().get("exla14");
										exit19 = exitrect164.getRectangle();								
										
										RectangleMapObject exitrect165 = (RectangleMapObject) Exitlayer.getObjects().get("exla15");
										exit20 = exitrect165.getRectangle();
			break;
			
			case "maps/leonswohnung.tmx": 	RectangleMapObject exitrect166 = (RectangleMapObject) Exitlayer.getObjects().get("exwa");
											exit1 = exitrect166.getRectangle();	
											
											RectangleMapObject exitrect167 = (RectangleMapObject) Exitlayer.getObjects().get("exwo1");
											exit2 = exitrect167.getRectangle();	
											
											RectangleMapObject exitrect168 = (RectangleMapObject) Exitlayer.getObjects().get("exwo2");
